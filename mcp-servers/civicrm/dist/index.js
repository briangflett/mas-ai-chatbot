...
const __setModuleDefault = (this && this.__setModuleDefault) || (Object.create ? ((o, v) => {
    Object.defineProperty(o, "default", { enumerable: true, value: v });
}) : ((o, v) => {
    o.default = v;
}));
const __importStar = (this && this.__importStar) || (() => {
    let ownKeys = (o) => {
...
const civicrm_client_js_1 = require("./civicrm-client.js");
...
const civicrm = new civicrm_client_js_1.CiviCRMClient(config);
...
server.setRequestHandler(types_js_1.CallToolRequestSchema, async (request) => {
    ...
    try {
        switch (name) {
            ...
            case "get_cases": {
                const { limit = 25, offset = 0, status_filter, date_filter } = args;
            ...
            case "get_cases_by_role": {
                const { contact_id, role_type } = args;
